<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gorder.aspx.cs" Inherits="BiuGame后台管理系统.html.Purchase" %>
...
<body  id="pagestyle" class="padding15">
	...
	<div class="bk-con-message message-section" id="iframe_box">
          ...
          <asp:Button ID="Button1" runat="server" Text="新增交易记录" CssClass="btn button_btn btn-danger" OnClick="Button1_Click" />
           </div>
           <!--列表内容-->
