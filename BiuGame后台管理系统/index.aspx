<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BiuGame后台管理系统.index" %>
                ...
                <div class="operate-header">
                    ...
                    <div class="bk-settings-section">
                        <div class="headerUser">
                            <a class="user-info clickBombbox" href="javascript:void(0)" data-position="bottom" data-type="arrow">
                                <asp:Label ID="Label1" runat="server" Text="欢迎您！"></asp:Label>
                                <i class="iconfont icon-iconfonticontrianglecopy"></i></a>
                            <div class="Bombbox">
                                <ul class="usercz menulist">
                                    <li class="column-name">
                                        <a href="javascript:void(0)" title="个人信息" class="menuUl_title" name="html/administrators.aspx" data-id="111"><i class="iconfont icon-guanliyuan"></i>个人信息</a>
                                    </li>
                                    <li class="column-name">
                                        <a href="javascript:void(0)" title="系统设置" class="menuUl_title" name="system_info.aspx" data-id="46"><i class="iconfont icon-system-copy"></i>系统设置</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" class="" onclick="dropout()"><i class="iconfont ">&#xe64f;</i>退出登录</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" class="" id='Lock'><i class="iconfont">&#xe612;</i>锁屏</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="notice-section clickBombbox">
                            <a href="javascript:void(0)" class="iconfont icon-xiazai41 notice-icon mode" data-id="2">
                                    ...
                                    <div class="tab-conent prompt_style ">
                                        <ul>
                                            <%-- <li class="prompt_info clearfix">
                                                <a href="javascript:void(0)" class="prompt_link"><em class="iconfont icon_prompt label-danger">&#xe745;</em><span class="prompt-xinxi">你有订单还没有处理请及时处理，点击查看详细</span></a>
                                            </li>
                                            <li class="prompt_info clearfix">
                                                <a href="javascript:void(0)" class="prompt_link"><em class="iconfont icon_prompt label-danger">&#xe745;</em><span class="prompt-xinxi">你有订单还没有处理请及时处理，点击查看详细</span></a>
                                            </li>
...
<script>
    var data = [{
        ...
        pid: 0,
        url: "index_home.aspx", //地址自定义 但需要和homepage保持一致
